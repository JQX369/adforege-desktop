...
export async function GET(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: error?.message || 'Failed to fetch boosts' }, { status: 500 })
  }
}
...
export async function POST(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: error?.message || 'Failed to create boost' }, { status: 500 })
  }
}
...
export async function DELETE(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: error?.message || 'Failed to delete boost' }, { status: 500 })
  }
}
