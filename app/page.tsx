...
export default function Home() {
  ...
  const [headingVariant, setHeadingVariant] = useState<string | undefined>(undefined)
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-background to-accent/10">
      ...
      {!trustTop && <TrustRow className="mx-auto max-w-4xl px-6" />}
      ...
      <div className="container mx-auto px-6 pb-24">
        {!showSwipeDeck ? (
          <div id="quiz-card" className="max-w-4xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
              <div className="text-left">
                ...
                <p className="text-body-sm text-muted-foreground">Swipe right to save, left to pass. We&apos;ll keep refining.</p>
              </div>
