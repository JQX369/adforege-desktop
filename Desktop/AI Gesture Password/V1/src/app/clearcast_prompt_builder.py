...
- Cite timestamps based on provided frames/audio.
- For every risk and technical issue, include `evidence_text` quoting the exact script line, narration, or frame content plus an `evidence_source` such as "Transcript 00:10-00:14" or "Frame 3".
