...
export const metadata: Metadata = {
  ...
  description:
    "Read FairyWize's terms of service and usage agreement. Understand our platform rules, user responsibilities, and service commitments.",
  keywords: [
    'terms of service',
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            These terms govern your use of FairyWize and outline our mutual
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground leading-relaxed">
                Welcome to FairyWize! These Terms of Service ("Terms") govern
                your access to and use of the FairyWize website, mobile
            ...
            <CardContent>
              <div className="space-y-4 text-muted-foreground">
                <p>
                  ...
                  the jurisdiction in which FairyWize operates, without regard
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2 text-muted-foreground">
                <p>
                  <strong>Email:</strong> legal@fairywize.com
                </p>
                <p>
                  <strong>Subject:</strong> Terms of Service Inquiry
                </p>
                <p>
                  <strong>Response Time:</strong> We aim to respond within 5-7
                  business days.
                </p>
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                ...
                prominent notice on our platform. Your continued use of
                FairyWize after such modifications constitutes acceptance of the
                updated Terms.
              </p>
            </CardContent>
          </Card>
        ...
        <div className="prose prose-lg max-w-4xl mx-auto text-muted-foreground mt-16">
          ...
          <p>
            These comprehensive terms of service outline the agreement between
            FairyWize and its users, ensuring a clear understanding of rights,
            responsibilities, and expectations for all parties using our
            AI-powered gift recommendation platform.
          </p>

          <h3>User Agreement</h3>
          <p>
            By accessing FairyWize, you enter into a binding agreement that
            defines how you may use our services. This includes guidelines for
            appropriate use, content creation, and interaction with other users
            and vendors on our platform.
          </p>

          <h3>Service Availability</h3>
          <p>
            While we strive for consistent service availability, FairyWize
            operates on a best-effort basis. We provide our services "as is" and
            cannot guarantee uninterrupted access or specific performance
            levels. Planned maintenance and unexpected outages may occur.
          </p>

          <h3>Content and Intellectual Property</h3>
          <p>
            All content on FairyWize, including but not limited to text,
            graphics, logos, and software, is protected by intellectual property
            laws. Users are granted a limited license to access and use the
            platform for personal, non-commercial purposes.
          </p>

          <h3>Payment and Commercial Terms</h3>
          <p>
            For vendors and commercial users, separate payment terms and
            commission structures apply. All financial transactions are
            processed securely, and payment obligations must be met according to
            the agreed terms and schedules.
          </p>

          <h3>Dispute Resolution</h3>
          <p>
            In the event of disputes, we encourage amicable resolution through
            our customer support channels. Formal disputes may be resolved
            through arbitration or the appropriate legal jurisdiction as
